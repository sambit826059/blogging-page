...
import { SignupInput } from "@sambit123456/blog-common";
    ...
    <div className="flex justify-center">
      <div>
        ...
        <div className="pt-8">
          ...
          <LabelledInput label="Email" placeholder="johncena@gmail.com" onChange={(e) => {
            setPostInputs({
              ...postInputs,
          ...
          <LabelledInput label="Password" type={"password"} placeholder="New@1234" onChange={(e) => {
            setPostInputs({
              ...postInputs,
